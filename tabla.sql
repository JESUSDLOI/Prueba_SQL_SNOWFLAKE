CREATE OR REPLACE PROCEDURE JESUS_DE_LA_OLIVA.SECRETOS.INTEGRACION_GIT("ENV" VARCHAR, "REFRESH" VARCHAR DEFAULT null, "STREAM" VARCHAR DEFAULT null, "RETRY" VARCHAR DEFAULT null)
RETURNS TABLE ("Filas insertadas" NUMBER(38,0), "Filas actualizadas" NUMBER(38,0))
LANGUAGE SQL
EXECUTE AS CALLER
AS 'DECLARE
    -- Variables
